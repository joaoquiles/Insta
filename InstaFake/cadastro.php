	...
	<div id="div-1">
		<form method="POST" action="processa.php">
			<center>
				...
				<br>
				<input type="password" name="confirmar" placeholder="Confirmar a senha">
				<br>
				<input type="submit" placeholder="Cadastre-se">
				<br><br><br>
			</center>
		</form>
	</div>
	<div id="div-2">
		<h3>Já tem uma conta <a href="index.php">Conecte-se</a></h3>
	</div>
</body>
</html>